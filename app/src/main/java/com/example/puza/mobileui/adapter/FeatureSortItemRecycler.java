...
public class FeatureSortItemRecycler extends RecyclerView.Adapter<FeatureSortItemRecycler.MyViewHolder> {
...
//    ImageView deleteIcon;
    ...
    public FeatureSortItemRecycler(Activity context, List<FeaturedSortItems> itemList) {
...
//    }
    ...
    @Override
    public FeatureSortItemRecycler.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.items_feature, parent, false);
        return new FeatureSortItemRecycler.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(FeatureSortItemRecycler.MyViewHolder holder, int position) {
