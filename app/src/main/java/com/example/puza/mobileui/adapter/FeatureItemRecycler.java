...
public class FeatureItemRecycler extends RecyclerView.Adapter<FeatureItemRecycler.MyViewHolder> {
...
//    ImageView deleteIcon;
    ...
    public FeatureItemRecycler(Activity context, List<FeaturedSortItems> itemList) {
...
//    }
    ...
    @Override
    public FeatureItemRecycler.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.items_feature, parent, false);
        return new FeatureItemRecycler.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(FeatureItemRecycler.MyViewHolder holder, int position) {
