...
//
//public class LatestOfferRecycler extends RecyclerView.Adapter<PopularRecycler.MyViewHolder> {
//
...
//
//
//    public LatestOfferRecycler(Activity context, List<MostPopularItems> itemList) {
...
//
//    @Override
//    public PopularRecycler.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
//        View itemView = LayoutInflater.from(parent.getContext())
//                .inflate(R.layout.items_products, parent, false);
//        return new PopularRecycler.MyViewHolder(itemView);
//    }
//
//    @Override
//    public void onBindViewHolder(PopularRecycler.MyViewHolder holder, int position) {
//
